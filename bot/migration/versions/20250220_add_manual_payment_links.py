...
down_revision = '20250115_extend_alembic_version_length'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    if 'manual_payment_links' in inspector.get_table_names():
        return
...
def downgrade() -> None:
    ...
    if 'manual_payment_links' not in inspector.get_table_names():
        return
